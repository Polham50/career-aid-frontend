...
export const loginWithAccessCode = async (name, accessCode) => {
...
export const addSchoolStudent = async (name, classLevel) => {
    const response = await fetch(`${API_BASE_URL}/school/students`, {
        method: 'POST',
        headers: getAuthHeaders(),
...
export const getCareerProfile = async (answers, childId) => {
...
export const getChatResponseStream = async (profile, messages) => {
...
export const getMockInterviewQuestions = async (careerName) => {
    try {
